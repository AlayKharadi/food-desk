          ...
          <div className="w3-sand w3-grayscale w3-large">
            ...
            <div className="w3-container" id="about">
              <div className="w3-content" style={{maxWidth: '700px'}}>
               ...
               <h1>
                <nav>
                <a href="" className="w3-block" style={{"text-decoration": "none" , "color":"black" }}>ABOUT US </a>
                </nav>
                </h1>
            ...
            <div className="w3-container" id="Feature">
              ...
              <h5 className="w3-center w3-padding-64">
                 ...
                 <h1>
                  <nav>
                  <a href="" className="w3-block" style={{"text-decoration": "none" , "color":"black" }}>FEATURE </a>
                  </nav>
                  </h1>
              ...
              <h5 className="w3-center w3-padding-64">
                 ...
                 <h1>
                  <nav>
                  <a href="" className="w3-block" style={{"text-decoration": "none" , "color":"black" }}>MEET THE TEAM </a>
                  </nav>
                  </h1>
